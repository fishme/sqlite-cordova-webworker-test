...
(function () {
    var DB_STATE_INIT, DB_STATE_OPEN, MAX_PART_SIZE, MAX_SQL_CHUNK, READ_ONLY_REGEX, SQLiteFactory, SQLitePlugin,
        SQLitePluginTransaction, argsArray, batchid, dblocations, iosLocationMap, isWorker, newSQLError, nextTick, root,
        txLocks, useflatjson;
